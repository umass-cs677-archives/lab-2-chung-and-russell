...
class TestCatalog(unittest.TestCase):
    ...
    def test_query_by_topic(self):
        ...
        response = urllib.request.urlopen("http://128.119.243.164:5000/query/graduate_school")
        ...
        response = urllib.request.urlopen("http://128.119.243.164:5000/query/distributed_systems")
        data = json.load(response)
    ...
    def test_query_by_item(self):
        ...
        response = urllib.request.urlopen("http://128.119.243.164:5000/query/1")
        data = json.load(response)
    ...
    def test_update(self):
        response = urllib.request.urlopen("http://128.119.243.164:5000/query/2")
        data = json.load(response)
        dict = list(data.values())[0]
        ...
        response = urllib.request.urlopen("http://128.119.243.164:5000/update/2/cost/increase/5")
        data = json.load(response)
        dict = list(data.values())[0]
        ...
        response = urllib.request.urlopen("http://128.119.243.164:5000/update/2/quantity/decrease/3")
        data = json.load(response)
        dict = list(data.values())[0]
        ...
        response = urllib.request.urlopen("http://128.119.243.164:5000/update/2/quantity/set/120")
        data = json.load(response)
        dict = list(data.values())[0]
        updated_quantity = dict["QUANTITY"]
